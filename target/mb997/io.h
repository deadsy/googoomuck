...
#define IO_AUDIO_I2S_WS   GPIO_NUM(PORTA, 4)	// AF6
#define IO_LCD_SCK        GPIO_NUM(PORTA, 5)	// AF5: spi1 clock
#define IO_LCD_SDO        GPIO_NUM(PORTA, 6)	// AF5: spi1 data MISO
#define IO_LCD_SDI        GPIO_NUM(PORTA, 7)	// AF5: spi1 data MOSI
#define IO_LCD_CS         GPIO_NUM(PORTA, 15)	// GPIO: lcd driver chip select
...
//#define IO_LCD_CS         GPIO_NUM(PORTB, 12) // AF5: spi2 nss
...
#define IO_AUDIO_I2S_MCK  GPIO_NUM(PORTC, 7)	// AF6
#define IO_AUDIO_I2S_SCK  GPIO_NUM(PORTC, 10)	// AF6
#define IO_AUDIO_I2S_SD   GPIO_NUM(PORTC, 12)	// AF6
