...
#define IO_LCD_SCK        GPIO_NUM(PORTA, 5)	// AF5: spi clock
#define IO_LCD_SDO        GPIO_NUM(PORTA, 6)	// AF5: spi data MISO
#define IO_LCD_SDI        GPIO_NUM(PORTA, 7)	// AF5: spi data MOSI
